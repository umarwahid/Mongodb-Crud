...
//             <td>
//               ${
//                 editedProduct && editedProduct.id === _id
...
//                   : `<i class="fas fa-pen" style="color: #235d04; cursor: pointer; font-size: 20px;" onclick="editProduct('${_id}', '${name}', '${price}', '${quantity}', '${description}')"></i>`
//               }
//             </td>
//             <td>
